      ...
      <div className="max-w-[1200px] mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-8">
          ...
          <div className="space-y-6">
            {/* Header card */}
            <div className="bg-white dark:bg-[#161B27] rounded-[16px] p-8">
              <div className="flex items-start justify-between gap-4 mb-6">
                ...
                <div className="h-10 w-10 bg-[#F7F9FC] rounded-full animate-pulse" />
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[...Array(4)].map((_, i) => (
                  <div key={i} className="h-16 bg-[#F7F9FC] rounded-lg animate-pulse" />
                ))}
              </div>
            </div>

            {/* Details card */}
            <div className="bg-white dark:bg-[#161B27] rounded-[16px] p-8 space-y-4">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="flex gap-4">
                  <div className="h-4 w-24 bg-[#E5E5EA] rounded animate-pulse shrink-0" />
                  <div className="h-4 flex-1 bg-[#F7F9FC] rounded animate-pulse" />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-[#161B27] rounded-[16px] p-6 space-y-4">
              <div className="h-11 w-full bg-[#2E6BE6]/20 rounded-full animate-pulse" />
              <div className="h-11 w-full bg-[#F7F9FC] rounded-full animate-pulse" />
            </div>
            <div className="bg-white dark:bg-[#161B27] rounded-[16px] p-6 space-y-3">
