export default function ScholarshipsLoading() {
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-[#F7F9FC] border-b border-[#E5E5EA]">
      ...
      <div className="max-w-[1200px] mx-auto px-6 py-10">
        <div className="flex gap-8">
          ...
          <aside className="hidden md:block w-72 shrink-0 space-y-4">
            ...
            {[...Array(5)].map((_, i) => (
              <div key={i} className="h-10 bg-[#F7F9FC] rounded-lg animate-pulse" />
            ))}
          </aside>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex gap-2 mb-5">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="h-8 w-24 bg-[#F7F9FC] rounded-full animate-pulse" />
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[...Array(8)].map((_, i) => (
                <div key={i} className="h-52 bg-[#F7F9FC] rounded-[12px] animate-pulse" />
              ))}
            </div>
          </div>
        </div>
