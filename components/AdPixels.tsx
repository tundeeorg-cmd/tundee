...
// Meta Pixel + TikTok Pixel base code, loaded site-wide (same treatment as
// GA in app/layout.tsx) so fbq/ttq exist on every page — not just /start —
// and survive a fresh page load elsewhere in the funnel (e.g. a magic-link
// click opening /auth/callback in a new tab). No-ops if an ID isn't set.
