...
export const translations = {
  nav: {
    ...
    navTracker: { th: 'ติดตาม', en: 'Tracker' },
  ...
  browse: {
    ...
    sortLabel: { th: 'เรียงตาม', en: 'Sort by' },
    sortAmount: { th: 'จำนวนเงิน', en: 'Amount' },
    sortDeadline: { th: 'วันหมดเขต', en: 'Deadline' },
  ...
  profile: {
    ...
    gradeLevels: {
      ...
      'ม.ต้น': { th: 'ม.ต้น (ม.1–3)', en: 'Lower Secondary (M1–3)' },
      'ม.ปลาย': { th: 'ม.ปลาย (ม.4–6)', en: 'Upper Secondary (M4–6)' },
      'ปวช.': { th: 'ปวช.', en: 'Vocational Cert. (ปวช.)' },
      'ปวส.': { th: 'ปวส.', en: 'Vocational Diploma (ปวส.)' },
  ...
  auth: {
    // ── Existing keys (keep for any code that references them) ──────────────
    ...
    email: { th: 'อีเมลของคุณ', en: 'Your email' },
    emailPlaceholder: { th: 'you@example.com', en: 'you@example.com' },
    password: { th: 'รหัสผ่าน', en: 'Password' },
    passwordPlaceholder: { th: 'กรอกรหัสผ่าน (8+ ตัวอักษร)', en: 'Enter password (8+ characters)' },
    ...
    loginBtn: { th: 'เข้าสู่ระบบด้วยรหัสผ่าน', en: 'Log In with Password' },
    signupBtn: { th: 'สมัครด้วยรหัสผ่าน', en: 'Sign Up with Password' },
    googleBtn: { th: 'Continue with Google', en: 'Continue with Google' },
    or: { th: 'หรือ', en: 'or' },
    ...
    // ── Magic link (new primary method) ────────────────────────────────────
    tagline:           { th: 'ค้นหาทุนที่ใช่สำหรับคุณ', en: 'Find the scholarship you deserve' },
    noAccountHint:     { th: 'ถ้ายังไม่มีบัญชี ระบบจะสร้างให้อัตโนมัติ', en: "No account yet? We'll create one for you." },
    magicLinkBtn:      { th: 'ส่งลิงก์เข้าสู่ระบบ →', en: 'Send me a sign-in link →' },
    magicLinkSending:  { th: 'กำลังส่ง...', en: 'Sending…' },
    magicLinkLabel:    { th: 'อีเมลของคุณ / Your email', en: 'Your email' },
    emailSentTitle:    { th: 'ส่งลิงก์ไปที่อีเมลแล้ว', en: 'Check your email' },
    emailSentBody:     { th: 'เราส่งลิงก์เข้าสู่ระบบไปที่อีเมลของคุณแล้ว กรุณาตรวจสอบ inbox และกดลิงก์เพื่อเข้าสู่ระบบ', en: 'We sent a sign-in link to your email. Check your inbox and click the link to continue.' },
    resend:            { th: 'ส่งอีกครั้ง', en: 'Resend' },
    resendCooldown:    { th: 'ส่งอีกครั้งใน', en: 'Resend in' },
    changeEmail:       { th: 'เปลี่ยนอีเมล', en: 'Change email' },
    linkExpiry:        { th: 'ลิงก์หมดอายุใน 1 ชั่วโมง', en: 'Link expires in 1 hour' },
    usePasswordToggle: { th: 'ใช้รหัสผ่านแทน', en: 'Use password instead' },
    hidePasswordToggle:{ th: 'ซ่อนตัวเลือกรหัสผ่าน', en: 'Hide password option' },
    emailInvalid:      { th: 'กรุณากรอกอีเมลที่ถูกต้อง', en: 'Please enter a valid email address' },
    magicLinkError:    { th: 'ส่งอีเมลไม่สำเร็จ กรุณาลองใหม่', en: 'Failed to send email. Please try again.' },
    orDivider:         { th: '── หรือ / or ──', en: '── or ──' },
    passwordSectionLabel: { th: 'เข้าสู่ระบบ / สมัครด้วยรหัสผ่าน', en: 'Sign in or sign up with a password' },
    passwordLoginBtn:  { th: 'เข้าสู่ระบบ', en: 'Log In' },
    passwordSignupBtn: { th: 'สมัครสมาชิก', en: 'Create Account' },
    alreadyHaveAccount:{ th: 'มีบัญชีแล้ว? เข้าสู่ระบบ', en: 'Already have an account? Log in' },
    noPasswordAccount: { th: 'ยังไม่มีบัญชี? สมัครใหม่', en: "Don't have an account? Sign up" },
  },
  tracker: {
    title:          { th: 'ติดตามการสมัคร',              en: 'My Applications' },
    subtitle:       { th: 'ติดตามสถานะการสมัครทุนของคุณ', en: 'Track your scholarship application status' },
    inProgress:     { th: 'กำลังสมัคร',                  en: 'In Progress' },
    saved:          { th: 'บันทึกไว้',                   en: 'Saved' },
    history:        { th: 'ประวัติ',                      en: 'History' },
    continue:       { th: 'ดำเนินการต่อ →',               en: 'Continue →' },
    startApplying:  { th: 'เริ่มสมัคร →',                 en: 'Start Applying →' },
    viewDetail:     { th: 'ดูรายละเอียด →',               en: 'View Details →' },
    steps:          { th: 'ขั้นตอน',                      en: 'steps' },
    noInProgress:   { th: 'ยังไม่มีทุนที่กำลังสมัคร',     en: 'No applications in progress' },
    noSaved:        { th: 'ยังไม่มีทุนที่บันทึกไว้',       en: 'No saved scholarships' },
    noHistory:      { th: 'ยังไม่มีประวัติการสมัคร',       en: 'No application history' },
    noInProgressSub:{ th: 'เริ่มค้นหาทุนที่เหมาะกับคุณ',  en: 'Start searching for scholarships' },
    browseBtn:      { th: 'ค้นหาทุน →',                   en: 'Browse Scholarships →' },
    requiresLogin:  { th: 'กรุณาเข้าสู่ระบบเพื่อดูการสมัครของคุณ', en: 'Please log in to view your applications' },
    loginBtn:       { th: 'เข้าสู่ระบบ',                  en: 'Log In' },
    statusWon:      { th: 'ได้รับทุน',                    en: 'Scholarship Won' },
    statusSubmitted:{ th: 'ส่งแล้ว',                       en: 'Submitted' },
    statusLost:     { th: 'ไม่ผ่าน',                      en: 'Not selected' },
    statusNoReply:  { th: 'รอผล',                         en: 'Awaiting result' },
    countLabel:     { th: 'กำลังสมัคร',                   en: 'in progress' },
    countSaved:     { th: 'บันทึกไว้',                    en: 'saved' },
  },
  save: {
    save:   { th: 'บันทึก', en: 'Save' },
    saved:  { th: 'บันทึกแล้ว', en: 'Saved' },
    unsave: { th: 'ยกเลิก', en: 'Remove' },
  },
  footer: {
    tagline: { th: 'ทุกทุน ทุกโอกาส ในที่เดียว', en: 'Every scholarship. Every opportunity. In one place.' },
    copyright: { th: '© 2569 ทุนดี (TunDee) · สร้างเพื่อนักเรียนไทยทุกคน', en: '© 2026 TunDee · Built for every Thai student' },
    updated: { th: 'ข้อมูลทุนอัปเดต: มิถุนายน 2569', en: 'Scholarship data updated: June 2026' },
...
export const FIELDS_OF_STUDY = [
  ...
  { th: 'วิทยาศาสตร์สิ่งแวดล้อม', en: 'Environmental Science' },
  { th: 'ยานยนต์', en: 'Automotive' },
  { th: 'สายอาชีพ', en: 'Vocational' },
];
