...
export const COPY = {
  ...
  question: 'ผลทุน "{name}" เป็นอย่างไรบ้างคะ? 🎓\n\nกดตอบสั้น ๆ เพื่อให้ทุนดีช่วยน้อง ๆ คนต่อไปได้ดีขึ้นนะคะ 🙏',

  /** Quick-reply labels for Message 1 (LINE caps labels at 20 characters). */
  choiceLabels: {
    awarded:     'ได้รับทุนแล้ว 🎉',
    waiting:     'ยังรอผลอยู่',
    not_applied: 'ไม่ได้สมัคร',
    rejected:    'ไม่ได้รับทุน',
  },

  // ── awarded branch ──────────────────────────────────────────────────────
  amountQuestion:
    'ยินดีด้วยนะคะ! 🎉 เก่งมาก ๆ เลยค่ะ\n\n' +
    'ได้รับทุนจำนวนเท่าไหร่คะ? พิมพ์เป็นตัวเลขได้เลยค่ะ (เช่น 50000)\n\n' +
    'ถ้าไม่สะดวกบอก กด "ข้าม" ได้เลยค่ะ',
  amountSkipLabel: 'ข้าม',
  amountUnparseable:
    'ขออภัยค่ะ ทุนดีอ่านตัวเลขไม่ออก 🙏\n' +
    'ลองพิมพ์เฉพาะตัวเลขอีกครั้งนะคะ (เช่น 50000) หรือกด "ข้าม" ค่ะ',

  consentQuestion:
    'ขอบคุณค่ะ 🙏\n\n' +
    'ทุนดีขออนุญาตนำผลทุนของน้อง (เฉพาะสถานะและจำนวนเงิน แบบไม่ระบุตัวตน) ' +
    'ไปใช้ในงานวิจัยเพื่อพัฒนาการเข้าถึงทุนของนักเรียนไทย ได้ไหมคะ?',
  consentYesLabel: 'ยินดีค่ะ',
  consentNoLabel:  'ไม่สะดวกค่ะ',
  consentYesReply: 'ขอบคุณมากค่ะ 🙏 ข้อมูลของน้องจะช่วยให้น้อง ๆ รุ่นต่อไปเข้าถึงทุนได้ง่ายขึ้นค่ะ',
  consentNoReply:  'รับทราบค่ะ 🙏 ทุนดีจะเก็บข้อมูลไว้สำหรับน้องคนเดียวเท่านั้น ไม่นำไปใช้ในงานวิจัยนะคะ',

  // ── waiting branch ──────────────────────────────────────────────────────
  waitingReply: 'รับทราบค่ะ 🙏 ทุนดีจะกลับมาถามใหม่ในอีกประมาณ {days} วันนะคะ ขอให้ได้ข่าวดีค่ะ 🤞',

  // ── not_applied branch ──────────────────────────────────────────────────
  notAppliedQuestion: 'รับทราบค่ะ 🙏\n\nอยากให้ทุนดีส่งเตือนก่อนหมดเขตทุนรอบหน้าไหมคะ?',
  remindYesLabel: 'รับการแจ้งเตือน',
  remindNoLabel:  'ไม่ต้องค่ะ',
  remindYesReply: 'เรียบร้อยค่ะ 🔔 ทุนดีจะเตือนก่อนหมดเขต 14 วัน และ 1 วันนะคะ',
  remindNoReply:  'รับทราบค่ะ 🙏 หากเปลี่ยนใจ เปิดการแจ้งเตือนได้ที่หน้าติดตามทุนค่ะ',

  // ── rejected branch ─────────────────────────────────────────────────────
  rejectedReply:
    'ขอบคุณที่บอกทุนดีนะคะ 🙏\n\n' +
    'ไม่ได้รอบนี้ ไม่ได้แปลว่าน้องไม่เก่งนะคะ ทุนแต่ละที่มีเกณฑ์ต่างกันมาก ' +
    'และหลายคนได้ทุนตอนสมัครรอบที่ 2 หรือ 3 ค่ะ 💙\n\n' +
    'ยังมีทุนอีกหลายร้อยทุนรออยู่ที่ tundee.org — ลองดูทุนที่ตรงกับน้องได้เลยค่ะ',
} as const;
